...
const float Kp = 0;//0.8; //CHANGE THESE
const float Ki = 0;//0.4;
const float Kd = 0;//0.3;
const int setPoint = 2700; // YOU SHOULD CHANGE THIS (This is what the robot will refer to as 'correct') Find position at set point and put the value in.
const int maxSpeed = 150; //YOU CAN CHANGE THIS
